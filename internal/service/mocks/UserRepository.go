...
func (_m *UserRepository) Create(_a0 context.Context, _a1 *domain.User) (*domain.User, error) {
...
func (_m *UserRepository) GetByEmail(_a0 context.Context, _a1 string) (*domain.User, error) {
	ret := _m.Called(_a0, _a1)
